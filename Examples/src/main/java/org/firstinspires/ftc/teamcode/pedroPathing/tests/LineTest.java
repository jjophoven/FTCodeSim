...
//        //line1.with(Constants.foresightConfig.brakeAtEnd.at(false));
//        line1 = line1.with(Constants.foresightConfig.maxDecelerationConstraint.at(49.9), Constants.foresightConfig.maxVelocityConstraint.at(35.0));
//        //line1 = line1.with(Constants.foresightConfig.maxAccelerationConstraint.at(120.0));
//        line2 = line(new Pose(DISTANCE + 72,72, 0), new Pose(DISTANCE + 72,-DISTANCE + 72, 0)).constant(0);
//        follower.follow(line1);
//        // TODO add pause button on Driver-station
//    }
//
//    @Override
//    public void loop() {
