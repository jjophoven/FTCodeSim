...
public class BlueAuto extends OpMode {
    ...
    public void init() {
        ...
        follower.setPose(new Pose(13/2.0, 15+12, 90));
    }

    @Override
    public void start() {
        line1 = line(new Pose(13/2.0, 15+12, 90), new Pose(13/2.0, 15+12 + 24*2+8, 90));
        line1.modifiers.add(Constants.foresightConfig.maxVelocityConstraint.at(40.0));
